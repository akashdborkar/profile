import * as defaultStrapi from './strapi-client.js'
import * as defaultMedia from './media-processor.js'
import type { StrapiBlock, MediaType, LinkPreviewCard } from './strapi-client.js'

// ---------------------------------------------------------------------------
// Payload types (Apify LinkedIn scraper output shape)
// ---------------------------------------------------------------------------
