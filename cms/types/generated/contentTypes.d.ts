...
export interface ApiAboutMeAboutMe extends Struct.SingleTypeSchema {
  collectionName: 'about_me';
  info: {
    description: 'Lead consultant personal bio, narrative, resume, and social links';
    displayName: 'AboutMe';
  ...
  attributes: {
    ...
    designation: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Lead Technical Consultant'>;
    elevatorPitch: Schema.Attribute.Text & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts \u2014 internal (with Dynamic Zone content) or external redirects';
    displayName: 'Blog';
    pluralName: 'blogs';
    singularName: 'blog';
  };
...
export interface ApiCertificationCertification
  ...
  info: {
    description: 'Professional certifications with optional expiry date';
...
export interface ApiEngagementAndActivityEngagementAndActivity
  extends Struct.CollectionTypeSchema {
  collectionName: 'engagement_and_activities';
  info: {
    description: 'Speaking events, community activities, and professional engagements';
    displayName: 'EngagementAndActivity';
    pluralName: 'engagement-and-activities';
    singularName: 'engagement-and-activity';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiFeaturedCurationFeaturedCuration
  extends Struct.SingleTypeSchema {
  collectionName: 'featured_curation';
  info: {
    description: 'Manual overrides for the featured content section (max 5 items)';
    displayName: 'FeaturedCurations';
    pluralName: 'featured-curations';
    singularName: 'featured-curation';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::featured-curation.featured-curation'
    > &
      Schema.Attribute.Private;
    manuallyCuratedList: Schema.Attribute.Component<
      'shared.curated-item',
      true
    > &
...
export interface ApiGalleryGallery extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Photo gallery items categorised by tag';
    displayName: 'Gallery';
  ...
  attributes: {
    categoryTag: Schema.Attribute.Enumeration<
      ['SpeakingEvents', 'Offices', 'TeamWork', 'Certifications']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    engagement_and_activities: Schema.Attribute.Relation<
      'manyToMany',
      'api::engagement-and-activity.engagement-and-activity'
    >;
    imageAsset: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::gallery.gallery'
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    challenge: Schema.Attribute.Blocks & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isFeatured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    leadershipRole: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::project.project'
    ...
    skills_matrices: Schema.Attribute.Relation<
      'manyToMany',
      'api::skills-matrix.skills-matrix'
    >;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface ApiSkillsMatrixSkillsMatrix
  extends Struct.CollectionTypeSchema {
  collectionName: 'skills_matrices';
  info: {
    description: 'Individual skills with category and experience level';
    displayName: 'SkillsMatrix';
    pluralName: 'skills-matrices';
    singularName: 'skills-matrix';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::skills-matrix.skills-matrix': ApiSkillsMatrixSkillsMatrix;
