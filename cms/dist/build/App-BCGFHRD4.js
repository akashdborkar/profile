...
`,Nn=h(x)`
  ...
  inset: 0;
  z-index: 1;
`,X=()=>{const{formatMessage:e}=D();return t.jsx(Nn,{justifyContent:"center",alignItems:"center",children:t.jsx(te,{children:e({id:"app.loading",defaultMessage:"Loading..."})})})},_n=({asset:e})=>{const{formatMessage:n}=D(),{alternativeText:r,ext:o,mime:s,url:a}=e,i=ee(a),[l,u]=c.useState(!1);if(c.useEffect(()=>{u(!1)},[i]),s?.includes(N.Image)){const p=ee(a);if(p)return t.jsxs(H,{children:[!l&&t.jsx(X,{}),t.jsx(Y,{children:t.jsx(An,{src:p,alt:r||e.name||"",onLoad:()=>u(!0),onError:()=>u(!0)})})]})}if(s?.includes(N.Video)&&i)return t.jsxs(H,{children:[!l&&t.jsx(X,{}),t.jsx(Y,{children:t.jsx(Pn,{src:i,controls:!0,title:e.name,onLoadedData:()=>u(!0),onError:()=>u(!0),children:n({id:f("asset-details.videoNotSupported"),defaultMessage:"Your browser does not support the video tag."})})})]});if(s?.includes(N.Audio)&&i)return t.jsxs(H,{children:[!l&&t.jsx(X,{}),t.jsx(Y,{children:t.jsx(x,{width:"100%",padding:4,justifyContent:"center",alignItems:"center",height:"100%",minHeight:"12rem",children:t.jsx($n,{src:i,controls:!0,onLoadedData:()=>u(!0),onError:()=>u(!0)})})})]});if((o?.toLowerCase()==="pdf"||o?.toLowerCase()===".pdf"||s==="application/pdf")&&i)return t.jsxs(H,{children:[!l&&t.jsx(X,{}),t.jsx(Y,{children:t.jsx(Ln,{src:`${i}#toolbar=0`,title:e.name,onLoad:()=>u(!0)})})]});const d=q(s,o);return t.jsx(H,{children:t.jsxs(kn,{justifyContent:"center",alignItems:"center",gap:1,direction:"column",hasRadius:!0,children:[t.jsx(d,{width:24,height:24}),t.jsx(y,{variant:"pi",children:n({id:f("asset-details.noPreview"),defaultMessage:"No preview available"})})]})})},fe="assetId",nt=()=>{const[{query:e},n]=Le(),r=e?.[fe],o=r?parseInt(r,10):null,s=o!==null&&!Number.isNaN(o),[a,i]=c.useState(!1),l=c.useRef(null),u=s&&!a;c.useEffect(()=>{s&&(l.current=o)},[s,o]);const g=c.useCallback(v=>{i(!1),n({[fe]:String(v)})},[n]),d=c.useCallback(()=>{s&&i(!0)},[s]);c.useEffect(()=>{if(!a)return;const v=window.setTimeout(()=>{n({[fe]:void 0},"remove"),i(!1),l.current=null},ht);return()=>window.clearTimeout(v)},[a,n]);const p=s||a;return{assetId:a?l.current??o:o,isVisible:u,shouldRenderDrawer:p,openDetails:g,closeDetails:d}},Gn=h(x)`
  flex: 0 0 calc(50% - ${({theme:e})=>e.spaces[2]});
`,O=({label:e,value:n})=>t.jsxs(Gn,{direction:"column",justifyContent:"flex-start",alignItems:"flex-start",gap:1,children:[t.jsx(y,{variant:"sigma",textColor:"neutral600",fontWeight:"semiBold",textTransform:"uppercase",children:e}),t.jsx(y,{variant:"pi",textColor:"neutral700",children:n??"-"})]}),On=h(bt)`
  width: 1.6rem;
  height: 1.6rem;
